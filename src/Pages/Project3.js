...
const tags = [
  "React", "React Router", "Firebase", "ExpressJS",
  "Vercel", "JWT", "MongoDB", "Google Auth",
  ...
  return (
    <div className="pt-24 pb-20">
      ...
      <div className="flex items-center gap-2 text-sm text-white/30 mb-8">
        ...
        <span>/</span>
        <span className="text-white/50">Lens Knight</span>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div>
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Lens Knight</h1>
          <p className="text-white/60 text-base leading-relaxed mb-6">
            A platform for booking different photography services with portfolio
            galleries, service listings, and customer reviews. Features Google-based
            authentication and full MongoDB CRUD operations.
          </p>
